...
#### Notes:
  * Machine learning tasks especially feature engineering done on a non-distributed system can cost a lot of memory. Tools like [SFrame](https://github.com/turi-code/SFrame) in Python can mitigate this problem by doing out-of-core processing and using more disk space. However, if you often do analyses in Pandas, a dataset with 10,000,000 rows and thousands of columns will blow up all the 64GB RAM space.
